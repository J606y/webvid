  ...
  <div class="page admin-page">
    ...
    <el-tabs v-model="tab" class="glass tabs">
      ...
      <el-tab-pane label="存储管理" name="storage">
        <div class="pane-head">
          <el-button type="primary" size="small" :icon="Plus" @click="openStorage()">添加存储</el-button>
        </div>
          ...
          <el-table-column :width="storageOpsWidth" align="right">
            <template #default="{ row }">
              <el-button v-if="row.driver === 'telegram'" link size="small" type="primary"
                :icon="Key" title="验证码登录" @click="openTgLogin(row)" />
              <el-button link size="small" :icon="EditPen" @click="openStorage(row)" />
        ...
        <el-dialog v-model="storageDlg" :title="editingStorage?.id ? '编辑存储' : '添加存储'" width="480px"
          ...
          <template #footer>
            <el-button @click="storageDlg = false">取消</el-button>
        ...
        <el-dialog v-model="tgDlg" title="Telegram 登录" width="400px" append-to-body>
          ...
          <template #footer>
            <el-button @click="tgDlg = false">取消</el-button>
      ...
      <el-tab-pane label="用户管理" name="users">
        <div class="pane-head">
          <el-button type="primary" size="small" :icon="Plus" @click="openUser()">添加用户</el-button>
        </div>
        <el-table :data="users">
          ...
          <el-table-column :width="isMobile ? 80 : 120" align="right">
            <template #default="{ row }">
              <el-button link size="small" :icon="EditPen" @click="openUser(row)" />
